...
Furthermore, the database is connected to an interactive dashboard on Streamlit. This dashboard allows you to view product data, such as the price of each product and various visualization options.
